...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">Preço TV</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto me-lg-4 d-md-inline-block me-0 me-md-3 my-2">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="#!">Trocar Usuario</a></li>
                    <li>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        ...
                        <div>
                            <a href="abount">Privacy Policy</a>
                            &middot;
                            <a href="abount">Terms &amp; Conditions</a>
                        </div>
                    </div>
                </div>
            </footer>
